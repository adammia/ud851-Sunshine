...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mErrorMessageDislplay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mErrorMessageDislplay = (TextView) findViewById(R.id.tv_error_message_display);
    ...
    private void showWeatherDataView() {
        mErrorMessageDislplay.setVisibility(View.INVISIBLE);
    ...
    private void showErrorMessage() {
        ...
        mErrorMessageDislplay.setVisibility(View.VISIBLE);
    }
