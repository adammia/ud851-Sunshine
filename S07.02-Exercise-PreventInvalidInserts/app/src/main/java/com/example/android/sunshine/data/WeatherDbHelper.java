...
//              COMPLETED (1) Append NOT NULL to each column's type declaration except for the _ID
                 ...
                 */
                        ...
                        WeatherEntry.COLUMN_HUMIDITY + " NOT NULL REAL, " +
                        WeatherEntry.COLUMN_PRESSURE + " NOT NULL REAL, " +

                        WeatherEntry.COLUMN_WIND_SPEED + " NOT NULL REAL, " +
                        WeatherEntry.COLUMN_DEGREES + " NOT NULL REAL" + ");";
